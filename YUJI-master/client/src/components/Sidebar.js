...
const Sidebar = () => {
    ...
    return (
        <div className='w-full h-full grid grid-cols-[48px,1fr] bg-white'>
            <div className='bg-gray-100 w-12 h-full rounded-tr-lg rounded-br-lg py-5 text-gray-600 flex flex-col justify-between'>
                <div>
                    <NavLink className={({ isActive }) => `w-12 h-12 flex justify-center items-center cursor-pointer hover:bg-gray-200 rounded ${isActive && "bg-gray-200"}`} title='chat'>
                ...
                <div className='flex flex-col items-center'>
                    ...
                    <button title='logout' className='w-12 h-12 flex justify-center items-center cursor-pointer hover:bg-gray-200 rounded' onClick={handleLogout}>
                        <span className='-ml-2'>
                            <BiLogOut size={20} />
                        </span>
                    </button>
                ...
                <div className='h-[calc(100vh-65px)] overflow-x-hidden overflow-y-auto scrollbar'>
...

                    {
                        allUser.map((conv, index) => {
                            return (
                                <div>
                                <NavLink to='/yuu' className='flex items-center gap-2 py-3 px-2 border border-transparent hover:border-primary rounded hover:bg-gray-100 cursor-pointer'>
                        <div>
                            <Avatar
                                imageUrl={yuuImage}
                                name='Yuu'
                        ...
                        <div>
                            <h3 className='text-ellipsis line-clamp-1 font-semibold text-base'>Yuu</h3>
                            <div className='text-gray-500 text-xs flex items-center gap-1'>
                                <p className='text-ellipsis line-clamp-1'>Chat with your AI friend, Yuu!</p>
                            </div>
                        </div>
                    </NavLink>
